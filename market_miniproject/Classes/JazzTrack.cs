...
namespace market_miniproject.Classes
{
    class JazzTrack : Track
    {
        ...
        public JazzTrack(int imageId, string pieceTitle,string author,int duration, double price, string leadInstrument, int soloDuration) :base(imageId, pieceTitle, author, duration, price)
        {
